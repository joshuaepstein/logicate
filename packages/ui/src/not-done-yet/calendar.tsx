  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-neutralgrey-700 rounded-md w-8 font-normal text-[0.8rem] dark:text-neutralgrey-600",
        row: "flex w-full mt-2",
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-neutralgrey-200 dark:[&:has([aria-selected])]:bg-neutralgrey-1100 [&:has([aria-selected].day-outside)]:bg-neutralgrey-200/50 dark:[&:has([aria-selected].day-outside)]:bg-neutralgrey-1100/50 [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day_today:
          "bg-neutralgrey-200 text-neutralgrey-1200 dark:bg-neutralgrey-1100 dark:text-neutralgrey-100",
        day_outside:
        ...
        day_disabled:
          "text-neutralgrey-700 opacity-50 dark:text-neutralgrey-600",
        day_range_middle:
