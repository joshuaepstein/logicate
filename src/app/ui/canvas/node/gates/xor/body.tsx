...
export default function XorBody({ item, className }: { item?: GateItem; className?: string }) {
  return (
    <svg
      ...
      height="32"
      fill="none"
      className={cn("min-h-8 w-[42px] select-none", className)}
      style={{
    ...
    >
      <path
        ...
        fill={(item && item.settings.color) || "#000"}
        fillRule="evenodd"
