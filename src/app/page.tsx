...
export default function Page() {
  return (
    <>
      <div
        className="relative flex min-h-[50dvh] w-full flex-col items-center justify-center bg-neutralgrey-300 md:min-h-[70dvh]"
        style={{
      ...
      >
        <h1 className="-mt-36 px-4 text-center text-2xl font-semibold leading-tight text-neutralgrey-1200 xs:p-0 xs:text-3xl md:text-5xl lg:text-6xl lg:leading-tight">
          ...
          <br />
          <span className="motion-preset-focus-lg bg-gradient-to-b from-blue-700 to-indigo-600 bg-clip-text font-semibold text-transparent motion-duration-1000 motion-delay-1000">
            Logic Gates
          </span>
        </h1>
