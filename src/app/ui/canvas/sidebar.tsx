      ...
      >
        ...
        >
          {(canvas.id === 'demo' && <p className="text-sm font-medium">Demo</p>) || (
            <motion.input
              className="hover:bg-neutralgrey-200 focus-visible:bg-neutralgrey-200 -m-1.5 mr-1 w-fit min-w-0 text-nowrap rounded-lg border-0 p-1.5 text-sm font-medium transition focus-visible:border-0 focus-visible:outline-none focus-visible:ring-0"
              value={name}
        ...
        >
          <div className="max-h-[calc(100dvh-5rem-72px+(16px*3))] min-h-[calc(100dvh-5rem-72px+(16px*3))] overflow-y-scroll">
            <div className="flex w-full flex-col items-start justify-start">
              <h5 className="text-neutralgrey-1100 p-4 text-sm font-medium">Inputs</h5>
            ...
            <div className="flex w-full flex-col items-start justify-start">
              <h5 className="text-neutralgrey-1100 p-4 text-sm font-medium">Gates</h5>
              <div className="flex flex-wrap items-start justify-between gap-5 p-4 pt-0">
            ...
            <div className="flex w-full flex-col items-start justify-start">
              <h5 className="text-neutralgrey-1100 p-4 text-sm font-medium">Outputs</h5>
              <div className="flex flex-wrap items-start justify-between gap-5 p-4 pt-0">
