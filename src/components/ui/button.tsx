  ...
  'inline-flex w-max items-center justify-center whitespace-nowrap rounded-lg ring-offset-base-background transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none data-[debug=focus]:ring-2 data-[debug=focus]:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        dark: 'box-border bg-neutralgrey-1200 text-neutralgrey-100 hover:bg-neutralgrey-1000 focus-visible:bg-neutralgrey-1000 focus-visible:ring-neutralgrey-600 disabled:bg-neutralgrey-300 disabled:text-neutralgrey-700 data-[debug=active]:bg-neutralgrey-1000 data-[debug=focus]:bg-neutralgrey-1000 data-[debug=hover]:bg-neutralgrey-1000 data-[debug=focus]:ring-neutralgrey-600 dark:bg-neutralgrey-100 dark:text-neutralgrey-1200 dark:hover:bg-neutralgrey-300 dark:focus-visible:bg-neutralgrey-300 dark:focus-visible:ring-neutralgrey-600 dark:disabled:bg-neutralgrey-800 dark:disabled:text-neutralgrey-500 dark:data-[debug=active]:bg-neutralgrey-300 dark:data-[debug=focus]:bg-neutralgrey-300 dark:data-[debug=hover]:bg-neutralgrey-300 dark:data-[debug=focus]:ring-neutralgrey-600',
        borders:
