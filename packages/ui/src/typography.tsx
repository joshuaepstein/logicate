...
>(({ className, ...props }, ref) => (
  <h1
    ref={ref}
    className={cn(
      "dark:text-base-white scroll-m-20 text-4xl font-semibold tracking-tight text-black lg:text-5xl",
      className,
    )}
    {...props}
  />
  ...
  ({ className, ...props }, ref) => (
    <h2
      ...
      className={cn(
        ...
        className,
        {
          "border-b-neutralgrey-400 dark:border-b-neutralgrey-900 border-b":
            props.withUnderline,
        },
      )}
      {...props}
...
const P = React.forwardRef<HTMLParagraphElement, PType>(
  ({ className, light, dark, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "text-neutralgrey-900 dark:text-neutralgrey-600 text-xl",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-neutralgrey-1200 dark:text-neutralgrey-100 text-lg font-semibold",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <small
    ref={ref}
    className={cn(
      "dark:text-base-white text-sm font-medium leading-none",
      className,
    )}
    {...props}
  />
