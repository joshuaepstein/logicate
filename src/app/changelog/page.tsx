    ...
    <>
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="relative flex flex-col items-center justify-start pb-20 pt-20 text-center">
          <h1 className="text-4xl font-semibold tracking-tight text-neutralgrey-1200 sm:text-5xl">Changelog</h1>
          <p className="mt-4 max-w-xl text-base leading-7 text-neutralgrey-800">
...
function ChangelogItem({ changelog }: { changelog: Changelog }) {
  return (
    <section id="2024-07-04" aria-labelledby="2024-07-04-heading" className="md:flex">
      <h2 id="2024-07-04-heading" className="pl-7 text-sm leading-6 text-neutralgrey-700 md:w-1/4 md:pl-0 md:pr-12 md:text-right">
        <a href="#2024-07-04">
      ...
      <div className="relative pb-16 pl-7 pt-2 md:w-3/4 md:pl-12 md:pt-0">
        <div className="absolute -top-3 bottom-0 left-0 w-px bg-neutralgrey-400 md:top-2.5"></div>
        <div className="absolute -left-1 -top-[1.0625rem] h-[0.5625rem] w-[0.5625rem] rounded-full border-2 border-neutralgrey-700 bg-white md:top-[0.4375rem]"></div>
        <div className="prose prose-sm prose-neutralgrey max-w-none prose-h3:mb-4 prose-h3:text-base prose-h3:leading-6 prose-h4:text-base prose-h4:font-medium prose-a:font-semibold prose-a:text-blue-700 hover:prose-a:text-blue-800">
          ...
          />
          <h4>Additions</h4>
          <ul className="list-disc marker:text-neutralgrey-900">
