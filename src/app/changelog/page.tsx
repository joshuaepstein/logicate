  ...
  return (
    <section id="2024-07-04" aria-labelledby="2024-07-04-heading" className="md:flex">
      ...
      <div className="relative pb-16 pl-7 pt-2 md:w-3/4 md:pl-12 md:pt-0">
        ...
        <div className="prose prose-sm prose-neutralgrey prose-h3:mb-4 prose-h3:text-base prose-h3:leading-6 prose-h4:text-base prose-h4:font-medium prose-a:font-semibold prose-a:text-blue-700 hover:prose-a:text-blue-800 max-w-none">
          <h2 className="text-2xl font-semibold">{changelog.title}</h2>
          <p>{changelog.subtitle}</p>
          <Image className="rounded-xl" src={'/_static/landing_demo.png'} width={1920} height={1080} alt="React Server Components" />
          <h4>Additions</h4>
