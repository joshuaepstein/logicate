...
export default function InviteTeacher({
  ...
  return (
    <Wrapper
      toEmail={to.email}
      reasonForEmail="You were invited to join a Logicate classroom as a teacher."
      preview={`You were invited to join ${classroomName} as a teacher.`}
    ...
    >
      ...
      <Text style={styles.text}>
        You have been invited to join <span className="font-medium">{classroomName}</span> as a teacher by{" "}
