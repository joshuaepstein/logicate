...
const PaginationLink = ({ className, isActive, paginateVariant = "spaced", size = "sm", ...props }: PaginationLinkProps) => (
  <a
    aria-current={isActive ? "page" : undefined}
    className={cn(
      paginationLinkVariants({
        variant: isActive ? `${paginateVariant}_active` : `${paginateVariant}_default`,
        size,
      }),
      className
    )}
