...
const config: Config = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      "hard-xs":
        "0px 0px 0px 1px rgba(10, 9, 11, 0.05), 0px 2px 2px -1px rgba(10, 9, 11, 0.04), 0px 2px 12px -1px rgba(10, 9, 11, 0.10)",
      "hard-sm":
        "0px 0px 0px 1px rgba(10, 9, 11, 0.05), 0px 6px 16px 0px rgba(10, 9, 11, 0.08)",
      "hard-md":
        "0px 0px 0px 1px rgba(10, 9, 11, 0.05), 0px 0px 3px -1px rgba(10, 9, 11, 0.04), 0px 16px 24px -6px rgba(10, 9, 11, 0.08)",
      "hard-lg":
        "0px 0px 0px 1px rgba(10, 9, 11, 0.05), 0px 0px 3px -1px rgba(10, 9, 11, 0.04), 0px 27px 30px -15px rgba(10, 9, 11, 0.13)",
      ...
      "checkbox-default":
        "0px 0px 0px 1px #17253829, 0px 1.5px 2px 0px #17253829",
