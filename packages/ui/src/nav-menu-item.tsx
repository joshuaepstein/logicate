    ...
    return (
      ...
      >
        ...
        {!iconOnly && (
          <span
            className={cn(
              "text-neutralgrey-1000 group-hover:text-neutralgrey-1300 w-max grow text-sm font-[475] transition",
              {
...
>(({ text, className, children, ...props }, ref) => (
  <p
    className={cn(
      "text-3xs text-neutralgrey-1000 px-4 py-2 font-[500] uppercase tracking-wide",
      className,
    )}
  >
    {text}
