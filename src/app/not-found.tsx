      ...
      <div className="flex min-h-[70dvh] flex-col items-center justify-center py-16">
        <div className="flex w-full flex-col items-center justify-center">
          ...
          <div className="flex flex-col">
            <p className="w-max text-left text-sm font-medium text-neutralgrey-900">
        ...
        <p className="mt-2 text-sm text-neutralgrey-800">The page you are looking for does not exist.</p>
      </div>
    </>
  )
}
